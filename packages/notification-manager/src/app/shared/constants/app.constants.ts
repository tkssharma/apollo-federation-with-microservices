...
export const USER_NOT_FOUND = 'Unable to get user from User Entity based on userAuthId';
...
export const INVALID_AUTH_TOKEN_SOURCE = 'Invalid Auth Token or invalid source of this token, unable to fetch SigningKey for token';